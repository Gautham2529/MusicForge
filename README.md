...
Below is a song generated by **MusicForge** and imported into **LMMS**.

![MusicForge Output](images/lmms_output.png)

MusicForge automatically generates:
...
The generated MIDI can be imported into **LMMS**, **FL Studio**, **Ableton Live**, **Reaper**, or any MIDI-compatible DAW.
---
